...
下表評估每個 assignment 對自學者的可行性（不是 Stanford 學生也能做嗎？需要什麼前置？）。所有 assignment 都連到 [GitHub repo](https://github.com/mihail911/modern-software-dev-assignments)。

### 各週 assignment 摘要

**[W1：LLM Prompting Playground](https://github.com/mihail911/modern-software-dev-assignments/tree/master/week1)**
- 時間：2-4 hr ｜ 可行性：⭐⭐⭐⭐⭐ 完全可做
- 前置：OpenAI 或 Anthropic API key

**[W2：First Steps in the AI IDE](https://github.com/mihail911/modern-software-dev-assignments/tree/master/week2)**
- 時間：3-5 hr ｜ 可行性：⭐⭐⭐⭐⭐ 完全可做
- 前置：Cursor 或 Claude Code 安裝

**[W3：Build a Custom MCP Server](https://github.com/mihail911/modern-software-dev-assignments/blob/master/week3/assignment.md)**
- 時間：4-8 hr ｜ 可行性：⭐⭐⭐⭐ 完全可做（需 Node/TS 基礎）
- 前置：Node.js + TypeScript SDK

**[W4：Coding with Claude Code](https://github.com/mihail911/modern-software-dev-assignments/blob/master/week4/assignment.md)**
- 時間：4-6 hr ｜ 可行性：⭐⭐⭐⭐⭐ 完全可做
- 前置：Claude Code 訂閱

**[W5：Agentic Development with Warp](https://github.com/mihail911/modern-software-dev-assignments/tree/master/week5)**
- 時間：3-5 hr ｜ 可行性：⭐⭐⭐⭐⭐ 完全可做
- 前置：Warp 安裝（macOS / Linux / Windows）

**[W6：Writing Secure AI Code](https://github.com/mihail911/modern-software-dev-assignments/blob/master/week6/assignment.md)**
- 時間：4-6 hr ｜ 可行性：⭐⭐⭐ 可做但偏深
- 前置：Semgrep CLI + 基礎 web security 知識

**[W7：Code Review Reps](https://github.com/mihail911/modern-software-dev-assignments/tree/master/week7)**
- 時間：3-5 hr ｜ 可行性：⭐⭐⭐⭐ 可做（需 GitHub PR 經驗）
- 前置：GitHub account + Graphite 試用

**[W8：Multi-stack Web App Builds](https://github.com/mihail911/modern-software-dev-assignments/tree/master/week8)**
- 時間：6-12 hr ｜ 可行性：⭐⭐⭐⭐⭐ 完全可做
